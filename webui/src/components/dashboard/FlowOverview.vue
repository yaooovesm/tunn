                      ...
                      <div>
                        <el-progress type="dashboard"
                          ...
                          <template #default>
                            ...
                            <span class="percentage-label" v-if="status.online">接收</span>
                            <span class="percentage-label" v-else><span style="color: #E6A23C">已离线</span></span>
                          </template>
                        </el-progress>
                      </div>
                    </template>
                      ...
                      <div>
                        <el-progress type="dashboard"
                          ...
                          <template #default>
                            ...
                            <span class="percentage-label" v-if="status.online">发送</span>
                            <span class="percentage-label" v-else><span style="color: #E6A23C">已离线</span></span>
                          </template>
                        </el-progress>
                      </div>
                      ...
                      <div>
                        <el-progress type="dashboard"
                          ...
                          <template #default>
                            ...
                            <span class="percentage-label" v-if="status.online">处理速度</span>
                            <span class="percentage-label" v-else><span style="color: #E6A23C">已离线</span></span>
                          </template>
                        </el-progress>
                      </div>
